...
<script lang="ts">
  ...
  $: postDate = toPostDate(new Date(post.created_at))
...
<div
  class="p-2 cursor-pointer relative border-t-0
      ...
      <div class="flex justify-between items-center mb-0.5">
        ...
        {#if showButtons}
          <button
            ...
            on:click|stopPropagation={() => handleIconClick("more")}
          >
